...
public class CandlestickFactoryTest {
	...
	public void geraCandlestickComApenasUmaNegociacao() {
		...
		CandleFactory fabrica = new CandleFactory();
		Candle candle = fabrica.gerarCandleParaData(negociacoes, data);
	...
	@Test
	public void negocicacaoDeTresDiasDiferentesGeraTresCandlesDiferentes() {
		...
		Assert.assertEquals(6000.0, candlesticks.get(0).getVolume(), 0.000001);
		Assert.assertEquals(50.0, candlesticks.get(0).getMinimo(), 0.000001);
		Assert.assertEquals(150.0, candlesticks.get(0).getMaximo(), 0.000001);
		Assert.assertEquals(50.0, candlesticks.get(0).getAbertura(), 0.000001);
		Assert.assertEquals(150.0, candlesticks.get(0).getFechamento(), 0.000001);
